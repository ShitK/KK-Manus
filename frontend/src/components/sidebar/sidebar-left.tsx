...
import { Activity, Bot, Menu, Store, Plus, Zap, ChevronRight, Loader2 } from 'lucide-react';
    ...
    >
      ...
      <SidebarContent className="[&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
        <SidebarGroup>
          ...
          <Link href="/agent-evals">
            <SidebarMenuButton
              className={cn('touch-manipulation', {
                'bg-accent text-accent-foreground font-medium': pathname === '/agent-evals',
              })}
              onClick={() => {
                if (isMobile) setOpenMobile(false);
              }}
