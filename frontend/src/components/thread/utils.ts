...
export const getToolIcon = (toolName: string): ElementType => {
  switch (toolName?.toLowerCase()) {
    ...
    case 'create-interview-plan':
    case 'generate-project-story':
    case 'generate-mock-questions':
      return BookOpen;
    case 'github-repo-interview-prep':
    case 'github_repo_interview_prep':
    case 'github-repo-answer-coach':
    case 'github_repo_answer_coach':
    case 'github-repo-interview-workflow':
    case 'github_repo_interview_workflow':
    case 'github-repo-interview-conversation-summary':
    case 'github_repo_interview_conversation_summary':
      return Github;
...
const TOOL_DISPLAY_NAMES = new Map([
  ...
  ['create-interview-plan', 'Create Interview Plan'],
  ['generate-project-story', 'Generate Project Story'],
  ['generate-mock-questions', 'Generate Mock Questions'],
  ['github-repo-interview-prep', 'GitHub 面试准备'],
  ['github_repo_interview_prep', 'GitHub 面试准备'],
  ['github-repo-answer-coach', 'GitHub 回答教练'],
  ['github_repo_answer_coach', 'GitHub 回答教练'],
  ['github-repo-interview-workflow', 'GitHub 面试工作流'],
  ['github_repo_interview_workflow', 'GitHub 面试工作流'],
  ['github-repo-interview-conversation-summary', 'GitHub 面试总结'],
  ['github_repo_interview_conversation_summary', 'GitHub 面试总结'],
