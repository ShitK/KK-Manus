...
export function UpgradeDialog({ open, onOpenChange, onDismiss }: UpgradeDialogProps) {
  ...
  return (
    <UnifiedUpgradeDialog
      ...
      icon={Crown}
      title="Unlock the Full KKManus Experience"
      description="You're currently using KKManus with limited demo capabilities. Upgrade now to access our most powerful AI model."
      theme="primary"
      size="sm"
