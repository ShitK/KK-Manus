...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | KKManus',
    description: 'Replay this agent conversation on KKManus',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | KKManus';
    const description =
      projectData.description ||
      'Replay this agent conversation on KKManus';
