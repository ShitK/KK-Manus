...
from agent.identity import DEFAULT_ADK_APP_NAME, normalize_event_author
        ...
        try:
            ...
            while True:
                ...
                result = await client.table('events').select(
                    ...
                    'author', ['user', 'assistant', DEFAULT_ADK_APP_NAME, 'fufanmanus']
            ...
            for event in all_events:
                try:
                    ...
                    # 构建LLM消息格式
                    message = {
                        "role": normalize_event_author(event.get('author')),
